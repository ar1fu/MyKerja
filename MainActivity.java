...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jobDB = new JobListDatabase(MainActivity.this);
        ...
        jobAdapter = new JobAdapter(MainActivity.this, this, job_id, job_position, company_name, salary, job_location, jobDesc1, jobDesc2, jobDesc3);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_myJob) {
            Intent intent = new Intent(MainActivity.this, MyJobList.class);
            startActivity(intent);
        }
    ...
    private void moveToLogin() {
        Intent intent = new Intent(MainActivity.this, App_Start.class);
    ...
    void storeDataInArrays() {
        Cursor cursor = jobDB.readAllData();
